...
export const ThemedIcon: React.FC<ThemedIconProps> = ({
  ...
  const renderIconPath = () => {
    switch (name) {
      case 'plus':
        return <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v16m8-8H4" />;
      case 'download':
        return <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />;
      case 'share':
        return <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 107.433-4.433 3 3 0 00-7.433 4.433z" />;
      case 'settings':
      ...
      case 'lab':
        return <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-.322-2.223l-3.55-3.551 1.706-4.265A1 1 0 0016.33 4H7.67a1 1 0 00-.932 1.389l1.706 4.265-3.55 3.551a2 2 0 00-.322 2.223l2.84 4.734A2 2 0 009.127 21h5.746a2 2 0 001.715-1.012l2.84-4.56z" />;
      case 'bell':
      ...
      case 'moon':
        return <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />;
      case 'sun':
      ...
      case 'export':
        return <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />;
      case 'import':
        return <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />;
      case 'chevronRight':
